...
namespace Libraria.Data.Migrations
{
    ...
    [Migration("20220127142853_InitialMigration_9.0")]
    partial class InitialMigration_90
    {
            ...
            modelBuilder.Entity("Libraria.Entity.Entities.KategoriLibri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("61276746-2063-43ac-88ae-a475c2c0cf58"),
                            Pershkrimi = "Roman"
                        },
                        new
                        {
                            ID = new Guid("8e34a420-a6c5-4604-af00-770d2d1ba1ab"),
                            Pershkrimi = "Proze"
                        },
                        new
                        {
                            ID = new Guid("df5600ae-26fe-4058-bb1f-8d6757d3934b"),
                            Pershkrimi = "POezi"
                        },
                        new
                        {
                            ID = new Guid("5f7b5bdb-6bca-475e-8fd1-12a02440e6ea"),
                            Pershkrimi = "Drama"
                        },
                        new
                        {
                            ID = new Guid("cd65c296-ac1c-4e0c-8339-734598f8e0bc"),
                            Pershkrimi = "Biografi"
                        },
                        new
                        {
                            ID = new Guid("c59b51af-6e06-4528-a804-b7a9116eea4a"),
                            Pershkrimi = "Histori"
                        });
                });
            ...
            modelBuilder.Entity("Libraria.Entity.Entities.StatusLibri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("ddfb6f5f-d61e-41cb-90a3-24c5d1176199"),
                            Pershkrimi = "I Lire"
                        },
                        new
                        {
                            ID = new Guid("51fa074c-cf45-4f14-b55c-949982c94349"),
                            Pershkrimi = "I dhene"
                        },
                        new
                        {
                            ID = new Guid("2a3651af-5b4a-46aa-a62f-ca37e4f50499"),
                            Pershkrimi = "I Demtuar"
                        },
                        new
                        {
                            ID = new Guid("71f34aa8-ea74-4473-bd90-4a166e475103"),
                            Pershkrimi = "I Hequr"
                        },
                        new
                        {
                            ID = new Guid("faf6e168-a051-48c4-a2fe-2569e6496dad"),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "756cbb31-d1b1-4742-9ffe-50af72491c62",
                            ConcurrencyStamp = "88b6560f-ea97-403e-9377-a9d451b608ad",
                            Name = "Menaxher",
                            NormalizedName = "Menaxher"
                        },
                        new
                        {
                            Id = "d2d7c403-2262-4abb-a79a-2c508b114320",
                            ConcurrencyStamp = "e9335edb-aa0f-43af-bdfe-de2022dd1747",
