...
namespace Libraria.Data.Migrations
{
    ...
    [Migration("20220113214134_InitialMigration_8.0")]
    partial class InitialMigration_80
    {
            ...
            modelBuilder.Entity("Libraria.Entity.Entities.KategoriLibri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("92b8bf84-d0d4-404b-aad1-24f4cd1ddda1"),
                            Pershkrimi = "Roman"
                        },
                        new
                        {
                            ID = new Guid("359fafc0-8ef8-47f3-8208-e244a51045b7"),
                            Pershkrimi = "Proze"
                        },
                        new
                        {
                            ID = new Guid("7b5af2b3-95b1-4e14-a03a-8657d9de0899"),
                            Pershkrimi = "POezi"
                        },
                        new
                        {
                            ID = new Guid("57eba866-d618-4615-91f4-dbe3ab4e7627"),
                            Pershkrimi = "Drama"
                        },
                        new
                        {
                            ID = new Guid("08dfc3e5-af49-4648-bd0f-2a8fcff51fee"),
                            Pershkrimi = "Biografi"
                        },
                        new
                        {
                            ID = new Guid("31a599a2-deb2-4ec3-a8b3-76fd06eea2d7"),
                            Pershkrimi = "Histori"
                        });
                });
            ...
            modelBuilder.Entity("Libraria.Entity.Entities.StatusLibri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("7bddd6f8-4043-4a94-a1f9-2f11ebd0f899"),
                            Pershkrimi = "I Lire"
                        },
                        new
                        {
                            ID = new Guid("6539ffee-0e6b-48ff-9fbd-fe4df0e9496c"),
                            Pershkrimi = "I dhene"
                        },
                        new
                        {
                            ID = new Guid("8d301399-200c-441e-892c-3b00df171482"),
                            Pershkrimi = "I Demtuar"
                        },
                        new
                        {
                            ID = new Guid("47804644-6f18-45bf-bca6-34d93a207004"),
                            Pershkrimi = "I Hequr"
                        },
                        new
                        {
                            ID = new Guid("50955a30-aee8-428f-8451-2faec336512d"),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "56deda7d-415f-494b-9a5c-9732b9eeb897",
                            ConcurrencyStamp = "dbb371e8-284b-4f76-9bd8-4fbbd6e5abab",
                            Name = "Menaxher",
                            NormalizedName = "Menaxher"
                        },
                        new
                        {
                            Id = "8d677183-440e-4606-9dc2-a1a0206be6c7",
                            ConcurrencyStamp = "088ea39f-7838-48a0-a688-7a1237f68af1",
