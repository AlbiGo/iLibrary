...
namespace Libraria.Data.Migrations
{
    ...
    [Migration("20220101174938_InitialMigration_4.2")]
    partial class InitialMigration_42
    {
            ...
            modelBuilder.Entity("Libraria.Entity.Entities.KategoriLibri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("d00e6f0f-ee3a-4f88-a369-02cc13bae67a"),
                            Pershkrimi = "Roman"
                        },
                        new
                        {
                            ID = new Guid("9d15e8bf-3d08-4108-9a72-57d038840927"),
                            Pershkrimi = "Proze"
                        },
                        new
                        {
                            ID = new Guid("d01763e8-95b9-47b7-8791-7a125a58bee8"),
                            Pershkrimi = "POezi"
                        },
                        new
                        {
                            ID = new Guid("891967d4-8468-4203-9ddd-ffc59579e94b"),
                            Pershkrimi = "Drama"
                        },
                        new
                        {
                            ID = new Guid("5e11f872-9c3b-47a1-9cad-8d8772284d59"),
                            Pershkrimi = "Biografi"
                        },
                        new
                        {
                            ID = new Guid("d7b4affd-c4fc-446f-a8e3-b96d8a82cd9e"),
                            Pershkrimi = "Histori"
                        });
                });
