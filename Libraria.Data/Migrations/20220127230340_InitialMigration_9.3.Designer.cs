...
namespace Libraria.Data.Migrations
{
    ...
    [Migration("20220127230340_InitialMigration_9.3")]
    partial class InitialMigration_93
    {
            ...
            modelBuilder.Entity("Libraria.Entity.Entities.KategoriLibri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("78693a80-3fb7-4b98-9d25-2dbc5dba9e6c"),
                            Pershkrimi = "Roman"
                        },
                        new
                        {
                            ID = new Guid("d8f62828-1b6d-4ed2-bf2a-36657d8aaabb"),
                            Pershkrimi = "Proze"
                        },
                        new
                        {
                            ID = new Guid("dbb65966-3642-459e-b291-47b1d271f0bc"),
                            Pershkrimi = "POezi"
                        },
                        new
                        {
                            ID = new Guid("65d4985c-2da8-497c-a1ef-05af9811c8ea"),
                            Pershkrimi = "Drama"
                        },
                        new
                        {
                            ID = new Guid("7bd68253-6f15-49ad-b815-40666bd583f0"),
                            Pershkrimi = "Biografi"
                        },
                        new
                        {
                            ID = new Guid("47742662-8960-4a49-b195-d1d5261f337c"),
                            Pershkrimi = "Histori"
                        });
                });
            ...
            modelBuilder.Entity("Libraria.Entity.Entities.StatusLibri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("8f9ed920-5a96-46ea-a1b3-cc1349327144"),
                            Pershkrimi = "I Lire"
                        },
                        new
                        {
                            ID = new Guid("ba6a8f75-be2a-4b85-84d3-b098f4ff8616"),
                            Pershkrimi = "I dhene"
                        },
                        new
                        {
                            ID = new Guid("185fbec3-0ffa-41f6-9a2b-1ca58cadceac"),
                            Pershkrimi = "I Demtuar"
                        },
                        new
                        {
                            ID = new Guid("3093051c-f17c-4468-8265-7e78545289fd"),
                            Pershkrimi = "I Hequr"
                        },
                        new
                        {
                            ID = new Guid("90b0f1e8-c716-41e6-a50e-f300be9a30ab"),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "7bc42717-8704-4223-9cf9-5894d31704b6",
                            ConcurrencyStamp = "87407dd6-735c-4170-aea4-1ed039aea627",
                            Name = "Menaxher",
                            NormalizedName = "Menaxher"
                        },
                        new
                        {
                            Id = "e19f9f62-9e75-477c-8f1b-dd3794052e05",
                            ConcurrencyStamp = "344ef416-3cd8-4fff-bdd0-fcdc614a9daf",
